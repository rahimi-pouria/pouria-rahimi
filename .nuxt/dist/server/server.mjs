import { reactive, getCurrentInstance, effectScope, ref, markRaw, toRaw, inject, watch, unref, isRef, isReactive, toRef, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, version, watchEffect, shallowRef, isReadonly, h, defineComponent, Transition, Suspense, provide, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, defineAsyncComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index-73aa8e3b.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/previewBlog-2771f345.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index-93a59c2c.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index-2d86d081.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  "home-layout": () => import("./_nuxt/homeLayout-e2e22ce5.js").then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-68e204bc.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-a82355a5.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
