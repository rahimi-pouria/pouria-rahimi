...
const styles = {
  "pages/Blog/index.vue": () => import('./_nuxt/index-styles.8b123947.mjs').then(interopDefault),
  "pages/Portfolio/index.vue": () => import('./_nuxt/index-styles.98aa5354.mjs').then(interopDefault),
  ...
  "layouts/homeLayout.vue": () => import('./_nuxt/homeLayout-styles.47553bcc.mjs').then(interopDefault),
  "components/home/aboutMe.vue": () => import('./_nuxt/aboutMe-styles.2df0a3cb.mjs').then(interopDefault),
